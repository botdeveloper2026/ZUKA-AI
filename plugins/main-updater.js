...
zuka-ai({
    ...
    try {
        await reply("🔍 Checking for ZUKA-AI updates...");
        ...
        if (latestCommitHash === currentHash) {
            return reply("✅ Your ZUKA-AI bot is already up-to-date!");
        }

        await reply("🚀 Updating ZUKA-AI Bot...");
        ...
        const sourcePath = path.join(extractPath, "ZUKA-AI-main");
